...
#ifndef FLATBUFFERS_GENERATED_SAMPLEAPPCONTEXTCACHING_QNN_TOOLS_SAMPLE_APP_H_
#define FLATBUFFERS_GENERATED_SAMPLEAPPCONTEXTCACHING_QNN_TOOLS_SAMPLE_APP_H_
...
inline flatbuffers::Offset<QnnTensorInfo> CreateQnnTensorInfoDirect(
  ...
  return qnn::tools::sample_app::CreateQnnTensorInfo(
      _fbb,
      id,
      name__);
}
...
inline flatbuffers::Offset<QnnGraphInfo> CreateQnnGraphInfoDirect(
  ...
  return qnn::tools::sample_app::CreateQnnGraphInfo(
      _fbb,
      name__,
      inputTensorsCount,
      inputTensorsInfo__,
...
inline flatbuffers::Offset<ContextCache> CreateContextCacheDirect(
  ...
  return qnn::tools::sample_app::CreateContextCache(
      _fbb,
      graphsCount,
      graphsInfo__,
      binaryCacheSize,
...
inline const qnn::tools::sample_app::ContextCache *GetContextCache(const void *buf) {
  return flatbuffers::GetRoot<qnn::tools::sample_app::ContextCache>(buf);
}

inline const qnn::tools::sample_app::ContextCache *GetSizePrefixedContextCache(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<qnn::tools::sample_app::ContextCache>(buf);
}

inline bool VerifyContextCacheBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<qnn::tools::sample_app::ContextCache>(nullptr);
}

inline bool VerifySizePrefixedContextCacheBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<qnn::tools::sample_app::ContextCache>(nullptr);
}

inline void FinishContextCacheBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<qnn::tools::sample_app::ContextCache> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SAMPLEAPPCONTEXTCACHING_QNN_TOOLS_SAMPLE_APP_H_
